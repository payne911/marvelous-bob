...
public class PolygonEnemy extends Enemy {
    ...
    public PolygonEnemy(UUID uuid, UUID spawnPoint, MovementStrategy<Vector2> moveStrategy,
            Vector2 center, float scale, Color color) {
        super(uuid, spawnPoint, moveStrategy);
        this.color = color;
    ...
    public PolygonEnemy(UUID uuid, UUID spawnPoint, MovementStrategy<Vector2> moveStrategy,
        ...
        this(uuid, spawnPoint, moveStrategy, center, 1, color);
    }

    public PolygonEnemy(UUID uuid, UUID spawnPoint, MovementStrategy<Vector2> moveStrategy,
            Vector2 center, float scale) {
        this(uuid, spawnPoint, moveStrategy, center, scale, DEFAULT_COLOR.cpy());
    }

    public PolygonEnemy(UUID uuid, UUID spawnPoint, MovementStrategy<Vector2> moveStrategy,
            Vector2 center) {
        this(uuid, spawnPoint, moveStrategy, center, 1, DEFAULT_COLOR.cpy());
    }
